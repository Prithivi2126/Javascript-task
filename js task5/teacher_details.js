...
function submit(){
  ...
  let teacherDetails = { name , email, number, password, c_password, gender,language, date};
    ...
    console.log(window);
     var url_string=window.location.href.toLocaleLowerCase();
      ...
      console.log(editvalue);
        ...
        document.getElementById("number").value = teacher.number;
        document.getElementById("password").value = teacher.password;
        document.getElementById("c_password").value = teacher.c_password;
        ...
        document.getElementById("language").value = teacher.language;
